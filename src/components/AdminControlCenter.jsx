...
export default function AdminControlCenter({ can, onNavigate }) {
  return (
    <div className="content-panel admin-operations-panel">
      ...
      {can("USER_MANAGE") && <button className="primary-button profile-save-button" type="button" onClick={() => onNavigate("profile")}><UserPlus size={15} /> Créer un utilisateur</button>}
