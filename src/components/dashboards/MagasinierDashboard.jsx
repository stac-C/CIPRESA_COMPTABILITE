...
export default function MagasinierDashboard({ onNavigate }) {
  return <RoleDashboardBase role="MAGASINIER" summary={{ title: "Espace magasinier", description: "Contrôlez les produits et les mouvements de stock au quotidien.", cards: [{ label: "Catalogue", value: "Produits", hint: "Références et prix" }, { label: "Opérations", value: "Mouvements", hint: "Entrées et sorties" }, { label: "Alerte", value: "Stock", hint: "Surveillez les seuils" }] }} actions={[{ id: "inventaire", label: "Inventaire", icon: "▱", description: "Gérer les produits" }, { id: "profile", label: "Mon profil", icon: "◉", description: "Gérer vos informations" }]} onNavigate={onNavigate} />;
}
